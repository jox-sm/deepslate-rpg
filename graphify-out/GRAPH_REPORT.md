...
## Summary
- 2217 nodes · 2362 edges · 158 communities (137 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `84118c7f`
...
1. `Deepslate Dungeons — Architecture Document` - 20 edges
2. `PostHog Next.js app router example` - 19 edges
3. `compilerOptions` - 16 edges
4. `Neon Serverless Postgres` - 16 edges
5. `Issue #59: Array index as React key in list rendering` - 16 edges
6. `Issue #60: Duplicate sleep utility defined in two files` - 16 edges
7. `Issue #62: Added route-specific helpers to cache-warmup module` - 16 edges
8. `Issue #64: Unnecessary Zod schema for simple query params` - 16 edges
9. `Obstacles & Troubles Faced` - 16 edges
10. `Issue #55: Inadequate state management - 100% local state, no caching` - 15 edges

## Surprising Connections (you probably didn't know these)
- `GET()` --calls--> `connectDB()`  [EXTRACTED]
  app/api/games/[id]/route.ts → models/games/mongodb/client.ts
- `GET()` --calls--> `validateJWTMiddleware()`  [EXTRACTED]
  app/api/games/route.ts → lib/jwt-validate.ts
- `GET()` --calls--> `retry()`  [EXTRACTED]
  app/api/games/route.ts → lib/retry.ts
- `POST()` --calls--> `rateLimitMiddleware()`  [EXTRACTED]
  app/api/push/route.ts → lib/middleware/rate-limit.ts
- `GET()` --calls--> `createAuthenticatedSupabaseClient()`  [EXTRACTED]
  app/api/test-supabase-auth/route.ts → lib/auth.ts
...
Cohesion: 0.05
Nodes (42): computedHash, computedHash, skillPath, source, sourceType, computedHash, skillPath, source (+34 more)
...
Cohesion: 0.06
Nodes (35): dependencies, autoprefixer, babel-plugin-react-compiler, bottleneck, class-variance-authority, clerk, @clerk/nextjs, clsx (+27 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (20): CharactersStepProps, characterValidators, itemValidators, mapValidators, cn(), Button, ButtonProps, buttonVariants (+12 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (21): createFieldValidator(), ValidationFn, ValidationResult, initialFormData, STEP_KEYS, UseGamesFormReturn, CHARACTER_VALIDATION, CharacterData (+13 more)
...
Cohesion: 0.11
Nodes (23): GamesFormWizardProps, ItemsStepProps, MapsStepProps, createEmptyCharacter(), createEmptyItem(), createEmptyMap(), STEP_KEYS, useGamesForm() (+15 more)
...
Cohesion: 0.18
Nodes (16): POST(), POST(), CACHE_KEYS, GET(), createAuthenticatedSupabaseClient(), getServiceToken(), ServiceConfig, serviceConfigs (+8 more)
...
Cohesion: 0.09
Nodes (9): convex, ConvexClientProvider(), cormorant, dmSans, geistMono, geistSans, metadata, SidebarItem (+1 more)
...
Cohesion: 0.14
Nodes (8): CardsGridProps, ApiGameResponse, ApiResponse, CardGrid, CardProps, GameCardProps, fetchGamesFromApi(), prepareGameCard()
...
Cohesion: 0.18
Nodes (13): ensureCachePrimed(), GET(), CACHE_KEYS, checkCachePrimed(), getCachedGameIds(), getGameFromCache(), setCachePrimed(), setGameInCache() (+5 more)

### Community 48 - "Community 48"
Cohesion: 0.12
Nodes (11): AbortableRequest, ApiResponse, IdempotencyError, IdempotentRequest, IdempotentResponse, PaginatedResponse, RequestManager, RequestState (+3 more)
...
Cohesion: 0.30
Nodes (10): sql, getGameById(), getGames(), insertGame(), insertGamesBatch(), updateGameLikes(), updateGamesLikesBatch(), getLikesQueue() (+2 more)
...
Cohesion: 0.35
Nodes (8): processGamesQueue(), connectDB(), getGamesQueue(), pushGameToQueue(), setToIdle(), setToWorking(), validateQueue(), validateQueueWorking()
...
Cohesion: 0.21
Nodes (10): uploadImage(), CharacterSchema, GameSchema, ItemSchema, MapSchema, CharacterDataDB, GamesFormDataDB, ItemDataDB (+2 more)
...
Cohesion: 0.20
Nodes (10): devDependencies, eslint, eslint-config-next, tw-animate-css, @types/mongoose, @types/node, @types/react, @types/react-dom (+2 more)
...
Cohesion: 0.40
Nodes (4): SQL_INJECTION_PATTERNS, ValidationOptions, ValidationResult, WEIRD_CHARACTER_PATTERNS

## Knowledge Gaps
- **1518 isolated node(s):** `@kilocode/plugin`, `plugin`, `editor.suggest.snippetsPreventQuickSuggestions`, `CACHE_KEYS`, `convex` (+1513 more)
...
- **Why does `useFormState()` connect `Community 15` to `Community 42`, `Community 10`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Community 8` to `Community 101`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `validateJWTMiddleware()` connect `Community 26` to `Community 75`, `Community 47`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
